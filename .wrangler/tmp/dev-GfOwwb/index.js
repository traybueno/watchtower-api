...
// .wrangler/tmp/bundle-ApNAb5/checked-fetch.js
...
function buildKey(gameId, playerId, saveKey) {
...
var GameRoom = class {
  ...
  async handleCreate(request) {
    ...
    this.roomState = {
      ...
      hostId,
      createdAt: Date.now(),
      players: /* @__PURE__ */ new Map([[hostId, { id: hostId, joinedAt: Date.now() }]])
    };
      ...
      switch (data.type) {
        case "broadcast":
          this.broadcast({
            ...
            from: playerId,
            data: data.data
          }, data.excludeSelf ? playerId : void 0);
          break;
        case "send":
          if (data.to) {
            this.sendTo(data.to, {
...
// .wrangler/tmp/bundle-ApNAb5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ApNAb5/middleware-loader.entry.ts
